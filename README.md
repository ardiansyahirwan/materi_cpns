...
berikut ini adalah pengertian negara di tinjau dari segi negara dibagi menjadi 4 sudut yaitu :

- `Negara sebagai Organisasi kekuasaan` , Negara mempunyai kekuasaan untuk mengatur hubungan antar manusia dalam masyarakat. dikemukakan oleh `Logeeman dan Harold J. Laski`
- `Negara sebagai organisasi politik` , Negara berfungsi sebagai alat dari masyarakat yang mempunyai kekuasaan untuk mengatur hubungan antar manusia sekaligus `menertibkan` serta `mengendalikan` gejala gejala kekuasaan yang muncul dalam masyarakat. dikemukakan oleh `roger Soltou dan robet M malcver`.
...
unsur sebagaimana yang dirumuskan dalam `Konvensi Montevideo 1933` yaitu :
- daerah tertentu
- penduduk yang tetap
- pemerintah
...
- `de jure` adalah pengakuan sebuah negara, terhadap sebuah negara baru yang pengakuannya berdasarkan `hukum internasional` yang di atur dalam sebuah perjanjian yang sah dan di akui secara internasional bahwa negara tersebut berkedaulatan penuh.
- `De facto`, Pengakuan yang didasarkan pada fakta yang ada di lapangan. Misalnya, suatu pemerintahan yang berhasil menguasai suatu wilayah secara efektif, meskipun belum diakui secara resmi oleh negara lain.
